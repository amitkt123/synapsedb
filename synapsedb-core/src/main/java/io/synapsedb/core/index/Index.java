...
import io.synapsedb.core.search.SearchRequest;
import io.synapsedb.core.search.SearchResponse;
        ...
        try {
            ...
            try {
                ...
                for (int i = start; i < end; i++) {
                    ...
                    Document synapseDoc = DocumentConverter.fromLuceneDocument(luceneDoc);
