...
import io.synapsedb.query.builder.*;
...
public final class QueryBuilders {
    ...
    private static class MatchAllQueryBuilder extends QueryBuilder {
        ...
        @Override
        public io.synapsedb.query.validation.ValidationResult validate() {
            return new io.synapsedb.query.validation.ValidationResult.Builder().build();
        }
